...

{
  ...
  public function paypaltobrinetree(){

    if($this->input->post()){

      $post = $this->input->post();
      // Braintree library
require APPPATH.'libraries/braintree/lib/Braintree.php';
 
$params = array(
  "testmode"   => "on",
  "merchantid" => "b6sjd8sz2mk6tdz4",
  "publickey"  => "jg5g466ygby6xz37",
  "privatekey" => "4b6f932778d94ffe576f1e2a8f75d3d7",
);
