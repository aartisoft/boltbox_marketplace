                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="gig-info-list">
                                        <span class="gig-deliver">Will deliver in <?php if($details['delivering_time'] > 1){echo $details['delivering_time'].' Days';}else{echo $details['delivering_time'].' Day';} ?> Days<span class="gig-count">  </span></span>
                                    </div>      
